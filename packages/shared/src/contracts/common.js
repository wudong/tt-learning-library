...
export function dataEnvelope(schema) { return z.object({ data: schema }); }
export function listEnvelope(schema) { return z.object({ data: z.array(schema), page: PageSchema }); }
