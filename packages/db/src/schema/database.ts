...
export interface TopicsTable { id: string; node_id: string; user_id: string; name: string; description: string | null; parent_topic_id: string | null; sort_order: number; is_system: number; created_at: string; updated_at: string; deleted_at: string | null }
export interface SkillsTable { id: string; node_id: string; user_id: string; topic_id: string | null; name: string; description: string | null; difficulty: string | null; status: string; is_system: number; created_at: string; updated_at: string; deleted_at: string | null }
...
export interface DrillsTable { id: string; node_id: string; user_id: string; title: string; description: string | null; instructions: string | null; difficulty: string | null; duration_minutes: number | null; repetition_target: number | null; status: string; created_at: string; updated_at: string; deleted_at: string | null }
